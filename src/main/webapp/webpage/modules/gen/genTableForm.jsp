...
<head>
		    ...
		    onDrop: function(table, row) {
		    	...
		    	//同步页面属性
		 		...
		 		var targetTR3 = $("#tab-3 #contentTable3 tbody tr:eq("+toIndex+")");//同步页面属性,目标元素位置（移动到该元素后面）
		  		...
		  		//同步自定义java对象
		 		var targetTR4 = $("#tab-4 #contentTable4 tbody tr:eq("+toIndex+")");//同步页面属性,目标元素位置（移动到该元素后面）
		  		var objTR4 = $("#tab-4 #contentTable4 tbody tr:eq("+fromIndex+")");//同步页面属性, 需要移动的元素
		  		if(fromIndex < toIndex){
	...
	function resetColumnNo(){
		...
		$("#tab-1 #contentTable1 tbody tr").each(function(index,element){
			 ...
			 $(this).find("input[name*=comments]").change(function(){//修改数据库列名，同时同步页面列名
				 var name = $(this).attr("name");
				 var newName = "page-"+name;
				 $("#tab-2 #contentTable2 tbody tr input[name='"+newName+"']").val($(this).val());
				 $("#tab-3 #contentTable3 tbody tr input[name='"+newName+"']").val($(this).val());
	...
	function addColumn(){
		  ...
		  column4.find('input:checkbox').iCheck({ checkboxClass: 'icheckbox_square-green', radioClass: 'iradio_square-blue', increaseArea: '20%' });
		  resetColumnNo();
			$("#contentTable1").tableDnD({//支持拖拽
	...
	function addForTreeTable(){
		// 如果是树表，不存在parent_id，则添加， 下面都是雷同。
		 if(!$("#tab-1 #contentTable1 tbody").find("input[name*=name][value=parent_id]").val()){
		  ...
		  column41.find('input:checkbox').iCheck({ checkboxClass: 'icheckbox_square-green', radioClass: 'iradio_square-blue', increaseArea: '20%' });
		 }
		 ...
		 if(!$("#tab-1 #contentTable1 tbody").find("input[name*=name][value=parent_ids]").val()){
		  ...
		  column42.find('input:checkbox').iCheck({ checkboxClass: 'icheckbox_square-green', radioClass: 'iradio_square-blue', increaseArea: '20%' });
		 }
		 ...
		 if(!$("#tab-1 #contentTable1 tbody").find("input[name*=name][value=name]").val()){
		  ...
		  column43.find('input:checkbox').iCheck({ checkboxClass: 'icheckbox_square-green', radioClass: 'iradio_square-blue', increaseArea: '20%' });
		 }
		 ...
		 if(!$("#tab-1 #contentTable1 tbody").find("input[name*=name][value=sort]").val()){
		  ...
		  column44.find('input:checkbox').iCheck({ checkboxClass: 'icheckbox_square-green', radioClass: 'iradio_square-blue', increaseArea: '20%' });
		 }
		  resetColumnNo();
		return false;
	}
	...
	function up(obj) { 
		...
		var objParentTR4 = $("#tab-4 #contentTable4 tbody tr:eq("+index+")");
		var prevTR4 = objParentTR4.prev(); 
		if (prevTR4.length > 0) { 
			prevTR4.insertAfter(objParentTR4); 
		} 
	...
	function down(obj) { 
		...
		var objParentTR4 = $("#tab-4 #contentTable4 tbody tr:eq("+index+")");
		var nextTR4 = objParentTR4.next(); 
		if (nextTR4.length > 0) { 
			nextTR4.insertBefore(objParentTR4); 
		} 
...
<body>
	...
	<table style="display:none">
		<tr id="template1" style="display:none">
				...
				<td>
					<input type="checkbox" class="form-control  " name="ck" value="0" />
				</td>
				<td>
				...
				<td>
					<input type="checkbox" class="form-control" name="columnList[0].isPk" value="0"/>
				</td>
			</tr>
			<tr id="template2" style="display:none">
				...
				<td>
					<input type="checkbox" class="form-control  " name="columnList[0].isQuery" value="0"  />
				</td>
				<td>
			...
			<tr id="template4" style="display:none">
				...
				<td>
					<select name="columnList[0].validateType" class="form-control required  m-b">
			...
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/save" method="post" class="form-horizontal">
				...
				<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
				   <tbody>
					...
					<button class="btn btn-success btn-rect btn-sm" onclick="return addColumn()"><i class="fa fa-plus"> 增加</i></button>
					<button class="btn btn-success btn-rect btn-sm" onclick="return delColumn()"><i class="fa fa-minus"> 删除</i> </button>
					<br/>
                        ...
                        <div id="tab-1" class="tab-pane active">
							...
							<c:if test="${empty genTable.name}">
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks " name="ck" value="0" />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[1].isPk" value="0" />
									</td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[2].isPk" value="0" />
									</td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[3].isPk" value="0" />
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[4].isPk" value="0" />
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[5].isPk" value="0" />
									</td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[6].isPk" value="0" />
									</td>
								</tr>
							</c:if>
								...
								<tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
									<td>
										...
										<input type="hidden"  name="columnList[1].isEdit" value="1"/>
									</td>
									<td>
										<input type="checkbox" class="i-checks " name="ck" value="0" />
									</td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[${vs.index}].isPk" value="${column.isPk}" ${column.isPk eq '1' ? 'checked' : ''}/>
									</td>
								</tr>
							</c:forEach>
                        ...
                        <div id="tab-2" class="tab-pane">
							...
							<c:if test="${empty genTable.name}">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[0].comments" value="主键" maxlength="200" class="required"/>
									</td>
									<td>
										<select name="columnList[0].javaType" class="form-control required m-b">
											<c:forEach items="${config.javaTypeList}" var="dict">
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[0].isForm" value="0"/>
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[0].isList" value="0"/>
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[0].isQuery" value="0"/>
									</td>
									<td>
										<select name="columnList[0].queryType" class="form-control required  m-b">
											<c:forEach items="${config.queryTypeList}" var="dict">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[1].comments" value="创建者" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[1].isForm" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[1].isList" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[1].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[2].comments" value="创建时间" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[2].isForm" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[2].isList" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[2].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[3].comments" value="更新者" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[3].isForm" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[3].isList" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[3].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[4].comments" value="更新时间" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[4].isForm" value="0"  />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[4].isList" value="0"  />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[4].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[5].comments" value="备注信息" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[5].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" readonly="readonly" name="page-columnList[6].comments" value="逻辑删除标记（0：显示；1：隐藏）" maxlength="200" class="required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[6].isForm" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[6].isList" value="0" />
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[6].isQuery" value="0"  />
									</td>
									<td>
								...
								<tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
									...
									<td>
										<input type="text" readonly="readonly" name="page-columnList[${vs.index}].comments" value="${column.comments}" maxlength="200" class="form-control required"/>
									</td>
									<td>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[${vs.index}].isForm" value="column.isForm" ${column.isForm eq '1' ? 'checked' : ''}/>
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[${vs.index}].isList" value="column.isList" ${column.isList eq '1' ? 'checked' : ''}/>
									</td>
									<td>
										<input type="checkbox" class="i-checks" name="columnList[${vs.index}].isQuery" value="column.isQuery" ${column.isQuery eq '1' ? 'checked' : ''}/>
									</td>
									<td>
                         ...
                         <div id="tab-4" class="tab-pane">
							...
							<c:if test="${empty genTable.name}">
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[0].isNull" value="0" />
									</td>
									<td>
										<select name="columnList[0].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[1].isNull" value="0" />
									</td>
									<td>
										<select name="columnList[1].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[2].isNull" value="0" />
									</td>
									<td>
										<select name="columnList[2].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[3].isNull" value="0" />
									</td>
									<td>
										<select name="columnList[3].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[4].isNull" value="0" />
									</td>
									<td>
										<select name="columnList[4].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
								...
								<tr>
									...
									<td>
										<select name="columnList[5].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
								...
								<tr>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[6].isNull" value="0"/>
									</td>
									<td>
										<select name="columnList[6].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
							...
							<c:forEach items="${genTable.columnList}" var="column" varStatus="vs">
								<tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
									...
									<td>
										<input type="checkbox" class="i-checks" name="columnList[${vs.index}].isNull" value="${column.isNull}" ${column.isNull eq '1' ? 'checked' : ''}/>
									</td>
									<td>
										<select name="columnList[${vs.index}].validateType" class="form-control required  m-b">
											<c:forEach items="${config.validateTypeList}" var="dict">
												<option value="${dict.value}" ${dict.value==column.validateType?'selected':''} title="${dict.description}">${dict.label}</option>
											</c:forEach>
										</select>
