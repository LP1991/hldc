...
<body class="gray-bg">
	...
	<div class="col-sm-12">
		<div class="pull-left">
	       ...
	       <button class="btn btn-success btn-rect btn-sm" data-toggle="tooltip" data-placement="left" onclick="test()" title="测试"><i class="fa fa-check"></i> 测试</button>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  width="80px"  class="nowrap  name">接口名称</th>
				<th  width="80px"  class="nowrap  type">接口类型</th>
				<th class="nowrap  url">请求URL</th>
				<th class="nowrap  body">请求body</th>
				<th  width="110px" class="nowrap  successmsg">成功时返回消息</th>
				<th  width="110px" class="nowrap  errormsg">失败时返回消息</th>
				<th class="nowrap  remarks">备注</th>
		...
		<c:forEach items="${page.list}" var="testInterface">
			<tr>
				...
				<td>
					<a href="javaScript:test('${testInterface.id}')" class="btn btn-success btn-xs" ><i class="fa  fa-check icon-white"></i> 测试</a>
					<shiro:hasPermission name="tools:testInterface:view">
						<a href="#" onclick="openDialogView('查看接口', '${ctx}/tools/testInterface/form?id=${testInterface.id}','800px', '500px')" class="btn btn-success btn-xs"><i class="fa fa-search-plus"></i></a>
					</shiro:hasPermission>
					<shiro:hasPermission name="tools:testInterface:edit">
    					<a href="#" onclick="openDialog('修改接口', '${ctx}/tools/testInterface/form?id=${testInterface.id}','800px', '500px')" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="tools:testInterface:del">
						<a href="${ctx}/tools/testInterface/delete?id=${testInterface.id}" onclick="return confirmx('确认要删除该接口吗？', this.href)"   class="btn btn-success btn-xs"><i class="fa fa-trash"></i></a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
