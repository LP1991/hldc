...
<head>
    ...
    <meta name="decorator" content="default"/>
      <!-- SUMMERNOTE -->
	 <link href="${ctxStatic}/bootstrap-table-master/docs/assets/css/docs.min.css" rel="stylesheet">
	 <script src="${ctxStatic}/bootstrap-table-master/docs/assets/js/docs.min.js"></script>
</head>
...
<div class="row">
  ...
  <ul class="nav">
    ...
    <li class="active"><a href="#overview-normalize">Normalize.css</a></li>
...
<li class="">
  <a href="#grid">栅格系统</a>
  <ul class="nav">
    <li class=""><a href="#grid-intro">简介</a></li>
    <li class=""><a href="#grid-media-queries">媒体查询</a></li>
    <li class=""><a href="#grid-options">栅格参数</a></li>
    <li class=""><a href="#grid-example-basic">实例：从堆叠到水平排列</a></li>
    <li class=""><a href="#grid-example-fluid">实例：流式布局容器</a></li>
    <li class=""><a href="#grid-example-mixed">实例：移动设备和桌面屏幕</a></li>
    <li class=""><a href="#grid-example-mixed-complete">实例：手机、平板、桌面</a></li>
    <li class=""><a href="#grid-example-wrapping">实例：多余的列（column）将另起一行排列</a></li>
    <li class=""><a href="#grid-responsive-resets">Responsive column resets</a></li>
    <li class=""><a href="#grid-offsetting">列偏移</a></li>
    <li class=""><a href="#grid-nesting">嵌套列</a></li>
    <li class=""><a href="#grid-column-ordering">列排序</a></li>
    <li class=""><a href="#grid-less">Less mixin 和变量</a></li>
  </ul>
</li>
<li>
  <a href="#type">排版</a>
...
<div class="col-md-9" role="main">
  ...
  <h1 id="overview" class="page-header"><a class="anchorjs-link " href="#overview" aria-label="Anchor link for: overview" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>概览</h1>

  <p class="lead">深入了解 Bootstrap 底层结构的关键部分，包括我们让 web 开发变得更好、更快、更强壮的最佳实践。</p>

  <h2 id="overview-doctype"><a class="anchorjs-link " href="#overview-doctype" aria-label="Anchor link for: overview doctype" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>HTML5 文档类型</h2>
...
<span class="nt">&lt;/html&gt;</span></code></pre></div>
  ...
  <h2 id="overview-mobile"><a class="anchorjs-link " href="#overview-mobile" aria-label="Anchor link for: overview mobile" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>移动设备优先</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard btn-clipboard-hover">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;meta</span> <span class="na">name=</span><span class="s">"viewport"</span> <span class="na">content=</span><span class="s">"width=device-width, initial-scale=1"</span><span class="nt">&gt;</span></code></pre></div>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;meta</span> <span class="na">name=</span><span class="s">"viewport"</span> <span class="na">content=</span><span class="s">"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"</span><span class="nt">&gt;</span></code></pre></div>
  ...
  <h2 id="overview-type-links"><a class="anchorjs-link " href="#overview-type-links" aria-label="Anchor link for: overview type links" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>排版与链接</h2>
  ...
  <h2 id="overview-normalize"><a class="anchorjs-link " href="#overview-normalize" aria-label="Anchor link for: overview normalize" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Normalize.css</h2>
  ...
  <h2 id="overview-container"><a class="anchorjs-link " href="#overview-container" aria-label="Anchor link for: overview container" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>布局容器</h2>
...
<div class="bs-docs-section">
  <h1 id="grid" class="page-header"><a class="anchorjs-link " href="#grid" aria-label="Anchor link for: grid" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>栅格系统</h1>
  ...
  <h2 id="grid-intro"><a class="anchorjs-link " href="#grid-intro" aria-label="Anchor link for: grid intro" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>简介</h2>
  ...
  <h2 id="grid-media-queries"><a class="anchorjs-link " href="#grid-media-queries" aria-label="Anchor link for: grid media queries" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>媒体查询</h2>
...
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span><span class="nd">:</span> <span class="o">@</span><span class="nt">screen-lg-min</span><span class="o">)</span> <span class="p">{</span> <span class="nc">...</span> <span class="p">}</span></code></pre></div>
  ...
  <h2 id="grid-options"><a class="anchorjs-link " href="#grid-options" aria-label="Anchor link for: grid options" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>栅格参数</h2>
  ...
  <h2 id="grid-example-basic"><a class="anchorjs-link " href="#grid-example-basic" aria-label="Anchor link for: grid example basic" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>实例：从堆叠到水平排列</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-example-fluid"><a class="anchorjs-link " href="#grid-example-fluid" aria-label="Anchor link for: grid example fluid" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>实例：流式布局容器</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-example-mixed"><a class="anchorjs-link " href="#grid-example-mixed" aria-label="Anchor link for: grid example mixed" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>实例：移动设备和桌面屏幕</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-offsetting"><a class="anchorjs-link " href="#grid-offsetting" aria-label="Anchor link for: grid offsetting" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>列偏移</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-nesting"><a class="anchorjs-link " href="#grid-nesting" aria-label="Anchor link for: grid nesting" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>嵌套列</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-column-ordering"><a class="anchorjs-link " href="#grid-column-ordering" aria-label="Anchor link for: grid column ordering" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>列排序</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="grid-less"><a class="anchorjs-link " href="#grid-less" aria-label="Anchor link for: grid less" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Less mixin 和变量</h2>
  <p>除了用于快速布局的<a href="#grid-example-basic">预定义栅格类</a>，Bootstrap 还包含了一组 Less 变量和 mixin 用于帮你生成简单、语义化的布局。</p>

  <h3 id=""><a class="anchorjs-link " href="#" aria-label="Anchor link for: " data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>变量</h3>
...
<span class="k">@grid-float-breakpoint</span><span class="nd">:</span>     <span class="nt">768px</span><span class="p">;</span></code></pre></div>
  ...
  <h3 id="mixin"><a class="anchorjs-link " href="#mixin" aria-label="Anchor link for: mixin" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>mixin</h3>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="-1"><a class="anchorjs-link " href="#-1" aria-label="Anchor link for:  1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>实例展示</h3>
...
<span class="nt">&lt;h6&gt;</span>h6. Bootstrap heading <span class="nt">&lt;small&gt;</span>Secondary text<span class="nt">&lt;/small&gt;&lt;/h6&gt;</span></code></pre></div>
  ...
  <!-- Body copy -->
  <h2 id="type-body-copy"><a class="anchorjs-link " href="#type-body-copy" aria-label="Anchor link for: type body copy" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>页面主体</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p&gt;</span>...<span class="nt">&lt;/p&gt;</span></code></pre></div>
  ...
  <!-- Body copy .lead -->
  <h3 id="-2"><a class="anchorjs-link " href="#-2" aria-label="Anchor link for:  2" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>中心内容</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"lead"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/p&gt;</span></code></pre></div>
  ...
  <!-- Using Less -->
  <h3 id="less-1"><a class="anchorjs-link " href="#less-1" aria-label="Anchor link for: less 1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>使用 Less 工具构建</h3>
  ...
  <h2 id="type-inline-text"><a class="anchorjs-link " href="#type-inline-text" aria-label="Anchor link for: type inline text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>内联文本元素</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html">You can use the mark tag to <span class="nt">&lt;mark&gt;</span>highlight<span class="nt">&lt;/mark&gt;</span> text.</code></pre></div>
  ...
  <h3 id="-3"><a class="anchorjs-link " href="#-3" aria-label="Anchor link for:  3" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>被删除的文本</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;del&gt;</span>This line of text is meant to be treated as deleted text.<span class="nt">&lt;/del&gt;</span></code></pre></div>
  ...
  <h3 id="-4"><a class="anchorjs-link " href="#-4" aria-label="Anchor link for:  4" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>无用文本</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;s&gt;</span>This line of text is meant to be treated as no longer accurate.<span class="nt">&lt;/s&gt;</span></code></pre></div>
  ...
  <h3 id="-5"><a class="anchorjs-link " href="#-5" aria-label="Anchor link for:  5" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>插入文本</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ins&gt;</span>This line of text is meant to be treated as an addition to the document.<span class="nt">&lt;/ins&gt;</span></code></pre></div>
  ...
  <h3 id="-6"><a class="anchorjs-link " href="#-6" aria-label="Anchor link for:  6" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>带下划线的文本</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;u&gt;</span>This line of text will render as underlined<span class="nt">&lt;/u&gt;</span></code></pre></div>
  ...
  <h3 id="-7"><a class="anchorjs-link " href="#-7" aria-label="Anchor link for:  7" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>小号文本</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;small&gt;</span>This line of text is meant to be treated as fine print.<span class="nt">&lt;/small&gt;</span></code></pre></div>
  ...
  <h3 id="-8"><a class="anchorjs-link " href="#-8" aria-label="Anchor link for:  8" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>着重</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;strong&gt;</span>rendered as bold text<span class="nt">&lt;/strong&gt;</span></code></pre></div>
  ...
  <h3 id="-9"><a class="anchorjs-link " href="#-9" aria-label="Anchor link for:  9" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>斜体</h3>
  <p>用斜体强调一段文本。</p>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;em&gt;</span>rendered as italicized text<span class="nt">&lt;/em&gt;</span></code></pre></div>
  ...
  <h2 id="type-alignment"><a class="anchorjs-link " href="#type-alignment" aria-label="Anchor link for: type alignment" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>对齐</h2>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-nowrap"</span><span class="nt">&gt;</span>No wrap text.<span class="nt">&lt;/p&gt;</span></code></pre></div>
  ...
  <h2 id="type-transformation"><a class="anchorjs-link " href="#type-transformation" aria-label="Anchor link for: type transformation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>改变大小写</h2>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-capitalize"</span><span class="nt">&gt;</span>Capitalized text.<span class="nt">&lt;/p&gt;</span></code></pre></div>
  ...
  <!-- Abbreviations -->
  <h2 id="type-abbreviations"><a class="anchorjs-link " href="#type-abbreviations" aria-label="Anchor link for: type abbreviations" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>缩略语</h2>
  ...
  <h3 id="-10"><a class="anchorjs-link " href="#-10" aria-label="Anchor link for:  10" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>基本缩略语</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;abbr</span> <span class="na">title=</span><span class="s">"attribute"</span><span class="nt">&gt;</span>attr<span class="nt">&lt;/abbr&gt;</span></code></pre></div>
  ...
  <h3 id="-11"><a class="anchorjs-link " href="#-11" aria-label="Anchor link for:  11" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>首字母缩略语</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;abbr</span> <span class="na">title=</span><span class="s">"HyperText Markup Language"</span> <span class="na">class=</span><span class="s">"initialism"</span><span class="nt">&gt;</span>HTML<span class="nt">&lt;/abbr&gt;</span></code></pre></div>
  ...
  <!-- Addresses -->
  <h2 id="type-addresses"><a class="anchorjs-link " href="#type-addresses" aria-label="Anchor link for: type addresses" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>地址</h2>
...
<span class="nt">&lt;/address&gt;</span></code></pre></div>
  ...
  <!-- Blockquotes -->
  <h2 id="type-blockquotes"><a class="anchorjs-link " href="#type-blockquotes" aria-label="Anchor link for: type blockquotes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>引用</h2>
  <p>在你的文档中引用其他来源的内容。</p>

  <h3 id="-12"><a class="anchorjs-link " href="#-12" aria-label="Anchor link for:  12" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>默认样式的引用</h3>
...
<span class="nt">&lt;/blockquote&gt;</span></code></pre></div>
  ...
  <h3 id="-13"><a class="anchorjs-link " href="#-13" aria-label="Anchor link for:  13" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>多种引用样式</h3>
  <p>对于标准样式的 <code>&lt;blockquote&gt;</code>，可以通过几个简单的变体就能改变风格和内容。</p>

  <h4 id="-14"><a class="anchorjs-link " href="#-14" aria-label="Anchor link for:  14" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>命名来源</h4>
...
<span class="nt">&lt;/blockquote&gt;</span></code></pre></div>
  ...
  <h4 id="-15"><a class="anchorjs-link " href="#-15" aria-label="Anchor link for:  15" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>另一种展示风格</h4>
...
<span class="nt">&lt;/blockquote&gt;</span></code></pre></div>
  ...
  <!-- Lists -->
  <h2 id="type-lists"><a class="anchorjs-link " href="#type-lists" aria-label="Anchor link for: type lists" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>列表</h2>

  <h3 id="-16"><a class="anchorjs-link " href="#-16" aria-label="Anchor link for:  16" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>无序列表</h3>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h3 id="-17"><a class="anchorjs-link " href="#-17" aria-label="Anchor link for:  17" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>有序列表</h3>
...
<span class="nt">&lt;/ol&gt;</span></code></pre></div>
  ...
  <h3 id="-18"><a class="anchorjs-link " href="#-18" aria-label="Anchor link for:  18" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>无样式列表</h3>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h3 id="-19"><a class="anchorjs-link " href="#-19" aria-label="Anchor link for:  19" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>内联列表</h3>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h3 id="-20"><a class="anchorjs-link " href="#-20" aria-label="Anchor link for:  20" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>描述</h3>
  <p>带有描述的短语列表。</p>
...
<span class="nt">&lt;/dl&gt;</span></code></pre></div>
  ...
  <h4 id="-21"><a class="anchorjs-link " href="#-21" aria-label="Anchor link for:  21" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>水平排列的描述</h4>
...
<div class="bs-docs-section">
  <h1 id="code" class="page-header"><a class="anchorjs-link " href="#code" aria-label="Anchor link for: code" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>代码</h1>

  <h2 id="code-inline"><a class="anchorjs-link " href="#code-inline" aria-label="Anchor link for: code inline" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>内联代码</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html">For example, <span class="nt">&lt;code&gt;</span><span class="ni">&amp;lt;</span>section<span class="ni">&amp;gt;</span><span class="nt">&lt;/code&gt;</span> should be wrapped as inline.</code></pre></div>
  ...
  <h2 id="code-user-input"><a class="anchorjs-link " href="#code-user-input" aria-label="Anchor link for: code user input" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>用户输入</h2>
...
To edit settings, press <span class="nt">&lt;kbd&gt;&lt;kbd&gt;</span>ctrl<span class="nt">&lt;/kbd&gt;</span> + <span class="nt">&lt;kbd&gt;</span>,<span class="nt">&lt;/kbd&gt;&lt;/kbd&gt;</span></code></pre></div>
  ...
  <h2 id="code-block"><a class="anchorjs-link " href="#code-block" aria-label="Anchor link for: code block" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>代码块</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;pre&gt;</span><span class="ni">&amp;lt;</span>p<span class="ni">&amp;gt;</span>Sample text here...<span class="ni">&amp;lt;</span>/p<span class="ni">&amp;gt;</span><span class="nt">&lt;/pre&gt;</span></code></pre></div>
  ...
  <h2 id="code-variables"><a class="anchorjs-link " href="#code-variables" aria-label="Anchor link for: code variables" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>变量</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;var&gt;</span>y<span class="nt">&lt;/var&gt;</span> = <span class="nt">&lt;var&gt;</span>m<span class="nt">&lt;/var&gt;&lt;var&gt;</span>x<span class="nt">&lt;/var&gt;</span> + <span class="nt">&lt;var&gt;</span>b<span class="nt">&lt;/var&gt;</span></code></pre></div>
  ...
  <h2 id="code-sample-output"><a class="anchorjs-link " href="#code-sample-output" aria-label="Anchor link for: code sample output" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>程序输出</h2>
...
<div class="bs-docs-section">
  ...
  <h2 id="tables-example"><a class="anchorjs-link " href="#tables-example" aria-label="Anchor link for: tables example" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>基本实例</h2>
...
<span class="nt">&lt;/table&gt;</span></code></pre></div>
  ...
  <h2 id="tables-striped"><a class="anchorjs-link " href="#tables-striped" aria-label="Anchor link for: tables striped" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>条纹状表格</h2>
...
<span class="nt">&lt;/table&gt;</span></code></pre></div>
  ...
  <h2 id="tables-bordered"><a class="anchorjs-link " href="#tables-bordered" aria-label="Anchor link for: tables bordered" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>带边框的表格</h2>
...
<span class="nt">&lt;/table&gt;</span></code></pre></div>
  ...
  <h2 id="tables-hover-rows"><a class="anchorjs-link " href="#tables-hover-rows" aria-label="Anchor link for: tables hover rows" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>鼠标悬停</h2>
...
<span class="nt">&lt;/table&gt;</span></code></pre></div>
  ...
  <h2 id="tables-condensed"><a class="anchorjs-link " href="#tables-condensed" aria-label="Anchor link for: tables condensed" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>紧缩表格</h2>
...
<span class="nt">&lt;/tr&gt;</span></code></pre></div>
  ...
  <h2 id="tables-responsive"><a class="anchorjs-link " href="#tables-responsive" aria-label="Anchor link for: tables responsive" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>响应式表格</h2>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h2 id="forms-inline"><a class="anchorjs-link " href="#forms-inline" aria-label="Anchor link for: forms inline" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>内联表单</h2>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h2 id="forms-horizontal"><a class="anchorjs-link " href="#forms-horizontal" aria-label="Anchor link for: forms horizontal" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>水平排列的表单</h2>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h2 id="forms-controls"><a class="anchorjs-link " href="#forms-controls" aria-label="Anchor link for: forms controls" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>被支持的控件</h2>
  <p>表单布局实例中展示了其所支持的标准表单控件。</p>

  <h3 id="-22"><a class="anchorjs-link " href="#-22" aria-label="Anchor link for:  22" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>输入框</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">placeholder=</span><span class="s">"Text input"</span><span class="nt">&gt;</span></code></pre></div>
  ...
  <h3 id="-23"><a class="anchorjs-link " href="#-23" aria-label="Anchor link for:  23" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>文本域</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;textarea</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">rows=</span><span class="s">"3"</span><span class="nt">&gt;&lt;/textarea&gt;</span></code></pre></div>
  ...
  <h3 id="-24"><a class="anchorjs-link " href="#-24" aria-label="Anchor link for:  24" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>多选和单选框</h3>
  ...
  <h4 id="-25"><a class="anchorjs-link " href="#-25" aria-label="Anchor link for:  25" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>默认外观（堆叠在一起）</h4>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h4 id="-26"><a class="anchorjs-link " href="#-26" aria-label="Anchor link for:  26" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>内联单选和多选框</h4>
...
<span class="nt">&lt;/label&gt;</span></code></pre></div>
  ...
  <h4 id="labelcheckbox-radio"><a class="anchorjs-link " href="#labelcheckbox-radio" aria-label="Anchor link for: labelcheckbox radio" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>不带label文本的Checkbox 和 radio</h4>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h3 id="select"><a class="anchorjs-link " href="#select" aria-label="Anchor link for: select" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>下拉列表（select）</h3>
...
<span class="nt">&lt;/select&gt;</span></code></pre></div>
  ...
  <h2 id="forms-controls-static"><a class="anchorjs-link " href="#forms-controls-static" aria-label="Anchor link for: forms controls static" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>静态控件</h2>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h2 id="forms-control-focus"><a class="anchorjs-link " href="#forms-control-focus" aria-label="Anchor link for: forms control focus" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>焦点状态</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">placeholder=</span><span class="s">"Readonly input here…"</span> <span class="na">readonly</span><span class="nt">&gt;</span></code></pre></div>
  ...
  <h2 id="forms-control-validation"><a class="anchorjs-link " href="#forms-control-validation" aria-label="Anchor link for: forms control validation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>校验状态</h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h3 id="-27"><a class="anchorjs-link " href="#-27" aria-label="Anchor link for:  27" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>添加额外的图标</h3>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h4 id="-28"><a class="anchorjs-link " href="#-28" aria-label="Anchor link for:  28" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>为水平排列的表单和内联表单设置可选的图标</h4>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h4 id="sr-only-label"><a class="anchorjs-link " href="#sr-only-label" aria-label="Anchor link for: sr only label" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>可选的图标与设置 <code>.sr-only</code> 类的 <code>label</code> </h4>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="forms-control-sizes"><a class="anchorjs-link " href="#forms-control-sizes" aria-label="Anchor link for: forms control sizes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>控件尺寸</h2>
  <p>通过 <code>.input-lg</code> 类似的类可以为控件设置高度，通过 <code>.col-lg-*</code> 类似的类可以为控件设置宽度。</p>

  <h3 id="-29"><a class="anchorjs-link " href="#-29" aria-label="Anchor link for:  29" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>高度尺寸</h3>
...
<span class="nt">&lt;select</span> <span class="na">class=</span><span class="s">"form-control input-sm"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/select&gt;</span></code></pre></div>
  ...
  <h3 id="-30"><a class="anchorjs-link " href="#-30" aria-label="Anchor link for:  30" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>水平排列的表单组的尺寸</h3>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <h3 id="column"><a class="anchorjs-link " href="#column" aria-label="Anchor link for: column" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>调整列（column）尺寸</h3>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="forms-help-text"><a class="anchorjs-link " href="#forms-help-text" aria-label="Anchor link for: forms help text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>辅助文本</h2>
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-default btn-lg btn-block"</span><span class="nt">&gt;</span>（块级元素）Block level button<span class="nt">&lt;/button&gt;</span></code></pre></div>
  ...
  <h2 id="buttons-active"><a class="anchorjs-link " href="#buttons-active" aria-label="Anchor link for: buttons active" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>激活状态</h2>
  ...
  <h3 id="button"><a class="anchorjs-link " href="#button" aria-label="Anchor link for: button" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>button 元素</h3>
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-default btn-lg active"</span><span class="nt">&gt;</span>Button<span class="nt">&lt;/button&gt;</span></code></pre></div>
  ...
  <h3 id="a"><a class="anchorjs-link " href="#a" aria-label="Anchor link for: a" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>链接（<code>&lt;a&gt;</code>）元素</h3>
...
<span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">class=</span><span class="s">"btn btn-default btn-lg active"</span> <span class="na">role=</span><span class="s">"button"</span><span class="nt">&gt;</span>Link<span class="nt">&lt;/a&gt;</span></code></pre></div>
  ...
  <h2 id="buttons-disabled"><a class="anchorjs-link " href="#buttons-disabled" aria-label="Anchor link for: buttons disabled" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>禁用状态</h2>
  <p>通过为按钮的背景设置 <code>opacity</code> 属性就可以呈现出无法点击的效果。</p>

  <h3 id="button-1"><a class="anchorjs-link " href="#button-1" aria-label="Anchor link for: button 1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>button 元素</h3>
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-default btn-lg"</span> <span class="na">disabled=</span><span class="s">"disabled"</span><span class="nt">&gt;</span>Button<span class="nt">&lt;/button&gt;</span></code></pre></div>
  ...
  <h3 id="a-1"><a class="anchorjs-link " href="#a-1" aria-label="Anchor link for: a 1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>链接（<code>&lt;a&gt;</code>）元素</h3>
...
<div class="bs-docs-section">
  <h1 id="images" class="page-header"><a class="anchorjs-link " href="#images" aria-label="Anchor link for: images" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>图片</h1>

  <h2 id="images-responsive"><a class="anchorjs-link " href="#images-responsive" aria-label="Anchor link for: images responsive" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>响应式图片</h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-responsive"</span> <span class="na">alt=</span><span class="s">"Responsive image"</span><span class="nt">&gt;</span></code></pre></div>
  ...
  <h2 id="images-shapes"><a class="anchorjs-link " href="#images-shapes" aria-label="Anchor link for: images shapes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>图片形状</h2>
  ...
  <div class="bs-example bs-example-images" data-example-id="image-shapes">
    <img data-src="holder.js/140x140" class="img-rounded" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
    <img data-src="holder.js/140x140" class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
    <img data-src="holder.js/140x140" class="img-thumbnail" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
  </div>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"bg-danger"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/p&gt;</span></code></pre></div>
  ...
  <h3 id="helper-classes-close"><a class="anchorjs-link " href="#helper-classes-close" aria-label="Anchor link for: helper classes close" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>关闭按钮</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"close"</span> <span class="na">aria-label=</span><span class="s">"Close"</span><span class="nt">&gt;&lt;span</span> <span class="na">aria-hidden=</span><span class="s">"true"</span><span class="nt">&gt;</span><span class="ni">&amp;times;</span><span class="nt">&lt;/span&gt;&lt;/button&gt;</span></code></pre></div>
  ...
  <h3 id="helper-classes-carets"><a class="anchorjs-link " href="#helper-classes-carets" aria-label="Anchor link for: helper classes carets" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>三角符号</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"caret"</span><span class="nt">&gt;&lt;/span&gt;</span></code></pre></div>
  ...
  <h3 id="helper-classes-floats"><a class="anchorjs-link " href="#helper-classes-floats" aria-label="Anchor link for: helper classes floats" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>快速浮动</h3>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="helper-classes-center"><a class="anchorjs-link " href="#helper-classes-center" aria-label="Anchor link for: helper classes center" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>让内容块居中</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Class
...
<div class="bs-docs-section">
  ...
  <h3 id="-31"><a class="anchorjs-link " href="#-31" aria-label="Anchor link for:  31" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>在...上可见</h3>
  ...
  <h3 id="-32"><a class="anchorjs-link " href="#-32" aria-label="Anchor link for:  32" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>在...上隐藏</h3>
...
<div class="bs-docs-section">
  <h1 id="less" class="page-header"><a class="anchorjs-link " href="#less" aria-label="Anchor link for: less" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>使用 Less</h1>
  ...
  <h2 id="less-bootstrap"><a class="anchorjs-link " href="#less-bootstrap" aria-label="Anchor link for: less bootstrap" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>编译 Bootstrap</h2>
  ...
  <h2 id="less-variables"><a class="anchorjs-link " href="#less-variables" aria-label="Anchor link for: less variables" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>变量</h2>
  <p>整个 Bootstrap 项目中使用了大量的变量，这些变量被用来代表颜色、空白（内部、边距）、字体等。详细内容请参考<a href="../customize/#less-variables-section">定制工具</a>。</p>

  <h3 id="less-variables-colors"><a class="anchorjs-link " href="#less-variables-colors" aria-label="Anchor link for: less variables colors" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>颜色</h3>
...
<span class="k">@text-color</span><span class="nd">:</span> <span class="o">@</span><span class="nt">black-50</span><span class="p">;</span></code></pre></div>
  ...
  <h3 id="less-variables-links"><a class="anchorjs-link " href="#less-variables-links" aria-label="Anchor link for: less variables links" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>链接</h3>
...
<span class="k">@headings-color</span><span class="nd">:</span>          <span class="nt">inherit</span><span class="p">;</span></code></pre></div>
  ...
  <h3 id="less-variables-icons"><a class="anchorjs-link " href="#less-variables-icons" aria-label="Anchor link for: less variables icons" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>图标</h3>
...
<span class="k">@caret-width-large</span><span class="nd">:</span>              <span class="nt">5px</span><span class="p">;</span></code></pre></div>
  ...
  <h2 id="less-mixins-vendor"><a class="anchorjs-link " href="#less-mixins-vendor" aria-label="Anchor link for: less mixins vendor" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>特定浏览器厂商的 mixin</h2>
  ...
  <p>通过这一个 mixin 来为所有组件设置盒模型。请参考这篇 <a href="https://developer.mozilla.org/en-US/docs/CSS/box-sizing" target="_blank">来自 Mozilla 的文章</a>。</p>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="less-mixins-animations"><a class="anchorjs-link " href="#less-mixins-animations" aria-label="Anchor link for: less mixins animations" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>动画</h3>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="less-mixins-opacity"><a class="anchorjs-link " href="#less-mixins-opacity" aria-label="Anchor link for: less mixins opacity" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>透明度</h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">复制</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="err">.</span><span class="na">placeholder</span><span class="err">(@</span><span class="nl">color</span><span class="p">:</span> <span class="o">@</span><span class="n">input-color-placeholder</span><span class="p">)</span> <span class="p">{</span>
  ...
  <h3 id="less-mixins-columns"><a class="anchorjs-link " href="#less-mixins-columns" aria-label="Anchor link for: less mixins columns" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>列</h3>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="less-mixins-gradients"><a class="anchorjs-link " href="#less-mixins-gradients" aria-label="Anchor link for: less mixins gradients" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>渐变</h3>
...
<span class="nn">#gradient</span> <span class="o">&gt;</span> <span class="nc">.horizontal-three-colors</span><span class="o">(</span><span class="nn">#777</span><span class="p">;</span> <span class="nn">#333</span><span class="p">;</span> <span class="nt">25</span><span class="nv">%</span><span class="p">;</span> <span class="nn">#000</span><span class="o">)</span><span class="p">;</span></code></pre></div>
  ...
  <h2 id="less-mixins-utility"><a class="anchorjs-link " href="#less-mixins-utility" aria-label="Anchor link for: less mixins utility" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>实用工具 mixin</h2>
  <p>实用工具 mixin 用于与不相关的 CSS 结合以达到特定目的或任务。</p>

  <h3 id="less-mixins-clearfix"><a class="anchorjs-link " href="#less-mixins-clearfix" aria-label="Anchor link for: less mixins clearfix" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Clearfix -- 清除浮动</h3>
  <p>建议为需要清除浮动的元素使用 <code>.clearfix()</code> mixin ，尽量不要直接添加 <code>class="clearfix"</code> 类。基于 <a href="https://twitter.com/necolas" target="_blank">Nicolas Gallagher</a> 的 <a href="http://nicolasgallagher.com/micro-clearfix-hack/" target="_blank">micro clearfix</a> 代码。</p>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="less-mixins-centering"><a class="anchorjs-link " href="#less-mixins-centering" aria-label="Anchor link for: less mixins centering" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>水平居中</h3>
...
<span class="p">}</span></code></pre></div>
  ...
  <h3 id="less-mixins-sizing"><a class="anchorjs-link " href="#less-mixins-sizing" aria-label="Anchor link for: less mixins sizing" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>尺寸助手 mixin</h3>
  <p>用于方便的指定对象的尺寸。</p>
...
<div class="bs-docs-section">
  <h1 id="sass" class="page-header"><a class="anchorjs-link " href="#sass" aria-label="Anchor link for: sass" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>使用 Sass</h1>
  ...
  <h2 id="sass-contents"><a class="anchorjs-link " href="#sass-contents" aria-label="Anchor link for: sass contents" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>包含的内容</h2>
  ...
  <h2 id="sass-installation"><a class="anchorjs-link " href="#sass-installation" aria-label="Anchor link for: sass installation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>安装</h2>
