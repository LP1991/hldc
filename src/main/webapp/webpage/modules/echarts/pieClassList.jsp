			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="echarts:pieClass:view">
						<a href="#" onclick="openDialogView('查看班级', '${ctx}/echarts/pieClass/form?id=${pieClass.id}','800px', '500px')" class="btn btn-success btn-xs"><i class="fa fa-search-plus"></i></a>
					</shiro:hasPermission>
					<shiro:hasPermission name="echarts:pieClass:edit">
    					<a href="#" onclick="openDialog('修改班级', '${ctx}/echarts/pieClass/form?id=${pieClass.id}','800px', '500px')" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="echarts:pieClass:del">
						<a href="${ctx}/echarts/pieClass/delete?id=${pieClass.id}" onclick="return confirmx('确认要删除该班级吗？', this.href)"   class="btn btn-success btn-xs"><i class="fa fa-trash"></i></a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
