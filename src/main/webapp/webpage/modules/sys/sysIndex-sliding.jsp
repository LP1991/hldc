...
<script type="text/javascript"	src="${ctxStatic}/sliding/js/jquery-1.7.1.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/tools/dataformat.js"></script>
<link id="easyuiTheme" rel="stylesheet"	href="${ctxStatic}/easyui/themes/default/easyui.css" type="text/css"/>
<link id="easyuiTheme" rel="stylesheet"	href="${ctxStatic}/easyui/themes/icon.css" type="text/css"/>
...
<link rel="stylesheet" href="${ctxStatic}/tools/css/common.css"	type="text/css"/>
...
<link rel="stylesheet"	href="${ctxStatic}/jquery/jquery-autocomplete/jquery.autocomplete.css"	type="text/css"/>
<script type="text/javascript"	src="${ctxStatic}/jquery/jquery-autocomplete/jquery.autocomplete.min.js"></script>

<link rel="shortcut icon" href="images/favicon.ico"/>
<link href="${ctxStatic}/sliding/css/main.css" rel="stylesheet" type="text/css"/>
<link href="${ctxStatic}/sliding/css/themesetting.css" rel="stylesheet" type="text/css"/>
<link href="${ctxStatic}/sliding/css/skins/black.css" rel="stylesheet" />
<link href="${ctxStatic}/sliding/css/powerFloat.css" rel="stylesheet" type="text/css" />
<link href="${ctxStatic}/sliding/css/smartMenu.css" rel="stylesheet" type="text/css" />
<link href="${ctxStatic}/sliding/css/skins/opera.css" rel="stylesheet" type="text/css" />
<link href="${ctxStatic}/sliding/css/scrollStyle.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery-powerFloat-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery-smartMenu-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery-class.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.core-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.widget-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.mouse-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.draggable-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.droppable-min.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.ui.sortable.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/jquery.cookie.js"></script>
<script type="text/javascript" src="${ctxStatic}/sliding/js/webos-core.js"></script>
<script>
	$(function() {
		//                var $script = $("script[src='${ctxStatic}/jquery/jquery-1.8.3.js']");
		//                $($script).remove();
		//                alert($script.attr("src"));
		$(".dock_tool_theme").live("click",
			function() {
				$("#themeSetting_wrap2")
						.append(
								"<div id='themeSetting_wrap' style='display:none;'></div>");
				$("#themeSetting_wrap").html(
						$("#themeSetting_wrap1").html());
...
<body>
	 ...
	 <div id='themeSetting_wrap' style='display:none;'></div>
		...
		<div  id="themeSetting_wrap1" style="display:none;">			
				...
				<div id="themeSetting_body" class="themeSetting_body">	
					...
					<a href="###" themeid="theme_blue" class="themeSetting_settingButton" id="themeSetting_theme_blue">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_blue.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_pinky_night" class="themeSetting_settingButton" id="themeSetting_theme_pinky_night">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_pinky_night.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_green" class="themeSetting_settingButton" id="themeSetting_theme_green">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_green.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_wood1" class="themeSetting_settingButton" id="themeSetting_theme_wood1">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_wood1.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_wood2" class="themeSetting_settingButton" id="themeSetting_theme_wood2">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_wood2.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_universe" class="themeSetting_settingButton" id="themeSetting_theme_universe">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_universe.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_metal" class="themeSetting_settingButton" id="themeSetting_theme_metal">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_metal.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_pinky_light" class="themeSetting_settingButton" id="themeSetting_theme_pinky_light">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_pinky_light.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_pinky_flower" class="themeSetting_settingButton" id="themeSetting_theme_pinky_flower">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_pinky_flower.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_christmas" class="themeSetting_settingButton" id="themeSetting_theme_christmas">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_christmas.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_2011" class="themeSetting_settingButton" id="themeSetting_theme_2011">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_2011.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_blue1" class="themeSetting_settingButton" id="themeSetting_theme_blue1">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_blue1.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_spring_festival" class="themeSetting_settingButton" id="themeSetting_theme_spring_festival">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_spring_festival.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_blue_glow" class="themeSetting_settingButton themeSetting_selected" id="themeSetting_theme_blue_glow">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_blue_glow.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_green_glow" class="themeSetting_settingButton" id="themeSetting_theme_green_glow">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_green_glow.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_orange_glow" class="themeSetting_settingButton" id="themeSetting_theme_orange_glow">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_orange_glow.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_valentinesDay" class="themeSetting_settingButton" id="themeSetting_theme_valentinesDay">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_valentinesDay.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_cloud" class="themeSetting_settingButton" id="themeSetting_theme_cloud">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_cloud.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_gravity" class="themeSetting_settingButton" id="themeSetting_theme_gravity">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_gravity.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_7_7" class="themeSetting_settingButton" id="themeSetting_theme_7_7">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_7_7.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_teachersDay" class="themeSetting_settingButton" id="themeSetting_theme_teachersDay">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_teachersDay.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_midAutumn" class="themeSetting_settingButton" id="themeSetting_theme_midAutumn">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_midAutumn.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_lookUpSky" class="themeSetting_settingButton" id="themeSetting_theme_lookUpSky">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_lookUpSky.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_grass" class="themeSetting_settingButton" id="themeSetting_theme_grass">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_grass.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_childhood" class="themeSetting_settingButton" id="themeSetting_theme_childhood">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_childhood.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_skyBlue" class="themeSetting_settingButton" id="themeSetting_theme_skyBlue">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_skyBlue.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_dandelionDream" class="themeSetting_settingButton" id="themeSetting_theme_dandelionDream">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_dandelionDream.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_paintingTime" class="themeSetting_settingButton" id="themeSetting_theme_paintingTime">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_paintingTime.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
					...
					<a href="###" themeid="theme_dreamSky" class="themeSetting_settingButton" id="themeSetting_theme_dreamSky">
						<div style="background: url(${ctxStatic}/sliding/images/bg/icon/theme_dreamSky.jpg) no-repeat;" class="themeSetting_settingButton_icon"></div>
		...
		<div id="zoomWallpaperGrid" class="zoomWallpaperGrid" style="position: absolute; z-index: -10; left: 0pt; top: 0pt; overflow: hidden; height: 381px; width: 1440px;">
			<img id="zoomWallpaper" class="zoomWallpaper" style="position: absolute; top: 0pt; left: 0pt; height: 381px; width: 1440px;" src="${ctxStatic}/sliding/images/bg/cloud.jpg">
		</div>
		<div class="taskbar_start_menu_container" id="startMenuContainer" _olddisplay="block" style="display: none;">  
			...
			<ul class="taskbar_start_menu">
				<li cmd="favorite">
					<div style="background: url(${ctxStatic}/login/images/exit.png) no-repeat left center;padding-left:30px;"
				...
				<li cmd="favorite">
					<div style="background: url(${ctxStatic}/login/images/exit.png) no-repeat left center;padding-left:30px;"
                         onclick="changeStyle('default')">默认主题 </div>
				</li>
				<li cmd="logout">
