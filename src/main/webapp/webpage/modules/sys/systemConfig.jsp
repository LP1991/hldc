		  			...
		  			<div class="panel panel-success">
                           ...
                           <div class="panel-body">
                                <table class="table table-striped">
								   <tbody>
										<tr>
											<td class="width-15 active"><label class="pull-right">邮箱服务器地址：</label></td>
											<td class="width-35">
												<form:input path="smtp" htmlEscape="false" maxlength="64" class="form-control "/>
											</td>
										</tr>
										<tr>
											<td class="width-15 active"><label class="pull-right">邮箱服务器端口：</label></td>
											<td class="width-35">
												<form:input path="port" htmlEscape="false" maxlength="64" class="form-control "/>
											</td>
										</tr>
										<tr>
											<td class="width-15 active"><label class="pull-right">系统邮箱地址：</label></td>
											<td class="width-35">
												<form:input path="mailName" htmlEscape="false" maxlength="64" class="form-control "/>
											</td>
										</tr>
										<tr>
											<td class="width-15 active"><label class="pull-right">系统邮箱密码：</label></td>
											<td class="width-35">
			...
			<form:form id="inputForm1" modelAttribute="systemConfig" action="${ctx}/sys/systemConfig/save" method="post" class="form-horizontal">
					  <div class="panel panel-success">
			              ...
			              <div class="panel-body">
			                 <table class="table table-striped">
										<tr>
											<td class="width-15 active"><label class="pull-right">短信用户名：</label></td>
											<td class="width-35">
												<form:input path="smsName" htmlEscape="false" maxlength="64" class="form-control "/>
											</td>
										</tr>
										<tr>
											<td class="width-15 active"><label class="pull-right">短信密码：</label></td>
											<td class="width-35">
