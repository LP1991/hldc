...
<body class="gray-bg">
	...
	<dc:bizHelp title="文件对象" label="" ></dc:bizHelp>
	...
	$(document).ready(function () {
		table = $('#contentTable').DataTable({
			...
			"bFilter" : false, //列筛序功能
			"ajax" : {
				url : "${ctx}/dc/metadata/dcObjectFile/ajaxlist",
				"data" : function (d) {
				...
				columnDefs : [{	                          
                    ...
                    "targets": "_all"
						...
						render : function (a, b) {
							var html = '<a href="#" onclick="openDialogView(\'查看文件对象\', \'${ctx}/dc/metadata/dcObjectFile/dataVie?id='+a.id
								+'\',\'800px\', \'680px\')" class="btn btn-success btn-xs" title="查看文件对象"><i class="fa fa-search-plus"></i></a>&nbsp;';
						//	html+= '<a href="#" onclick="openDialog(\'修改数据对象\', \'${ctx}/dc/metadata/dcObjectMain/form?id='+a.id+'\',\'800px\', \'700px\')" class="btn btn-success btn-xs" title="编辑对象"><i class="fa fa-edit"></i></a>&nbsp;';
							...
							html+= '<a href="#" onclick="openDialog(\'修改\', \'${ctx}/dc/metadata/dcObjectFile/updateDco?id='+a.id+'\',\'800px\', \'700px\')" class="btn btn-success btn-xs" title="修改"><i class="fa fa-edit"></i></a>&nbsp;';
							//html+= '<a  onclick="deleteA(\'${ctx}/dc/metadata/dcObjectMain/ajaxDele?id='+a.id+'\',\'文件\') " class="btn btn-success btn-xs" title="删除对象"><i class="fa fa-trash"></i></a>&nbsp;';
							}else{
							html+= '<a  onclick="getAu(\'${ctx}/dc/metadata/dcObjectMain/getAu?id='+a.id+'\',\'数据对象\') " class="btn btn-success btn-xs" title="申请权限"><i class="fa fa-ban"></i></a>&nbsp;';
							}
