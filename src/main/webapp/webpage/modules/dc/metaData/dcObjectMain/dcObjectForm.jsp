...
<body>
	<form:form id="inputForm" modelAttribute="dcSearchLabel" action="${ctx}/dc/metaData/dcObjectMain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		function doSubmit(index, table) {
			...
			submitData('${ctx}/dc/metadata/dcObjectMain/ajaxSaveTab', getFormParams('inputForm'), function (data) {
