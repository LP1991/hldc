	...
	function doSubmit(index, table) {//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
		setTimeout(function() {//TODO待后期优化
			if (validateForm.form()) {
				...
				submitData('${ctx}/dc/metadata/dcObjectTable/ajaxSaveTable',
...
<body>
	<form:form id="inputForm" modelAttribute="objectTable" action="#" autocomplete="off" method="post" class="form-horizontal change_table_margin "  >
		<form:hidden path="id" />
	...
	<%-- <form:form id="inputForm" modelAttribute="objectMain12" action="#"
		...
		<table
		 ...
		 <div class="tabs-container form-horizontal change_table_margin "  >
	...
	$(document).ready(function () {
        tablenu = $('#contentTable').DataTable({
			...
			"bFilter" : false, //列筛序功能
			"ajax" : {
				url : "${ctx}/dc/metadata/dcObjectTable/ajaxfieldlist?belong2Id="+$('#id').val(),
				"data" : function (d) {
