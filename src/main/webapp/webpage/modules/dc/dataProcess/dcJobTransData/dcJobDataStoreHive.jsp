...
<body class="white-bg">
	...
	<div class="ibox">
		...
		<sys:message hideType="0" content="默认显示20条记录!"/>		
		<div class="row">
			<div class="col-sm-12">
			...
			<table id="previewTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable display" cellspacing="0" style="overflow: scroll;width:100px;">
		   	<thead>
				<tr>
