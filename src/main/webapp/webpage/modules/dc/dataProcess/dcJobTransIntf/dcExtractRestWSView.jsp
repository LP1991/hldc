	...
	<input type="hidden" id="id"/>
		...
		<fieldset class="change_table_margin">
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
				...
				<tr>
					<td class="width-15 active" ><label class="pull-right">采集接口URL：</label></td>
					<td class="width-35">${formData.restUrl}</td>
				</tr>
				<tr>
					<td class="width-15 active" ><label class="pull-right">接口调用方式：</label></td>
					<td class="width-35">${formData.restType}</td>
				</tr>
				<tr>
					<td class="width-15 active" ><label class="pull-right">表单参数方式：</label></td>
					<td class="width-35">${formData.restContentType}</td>
				</tr>
				<tr>
