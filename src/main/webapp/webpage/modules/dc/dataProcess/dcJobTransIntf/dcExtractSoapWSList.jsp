...
<html>
<head>
	<title>Soap WebService采集任务</title>
...
<div class="wrapper wrapper-content">
	...
	<dc:bizHelp title="Soap WebService数据采集" label="Soap WebService数据采集作业, 主要用于采集服务端为Soap 架构的webservice的业务数据, 目前存储于mysql数据库." ></dc:bizHelp>
	<!-- 查询条件 -->
	<div class="row">
		<div class="col-sm-12">
			<form:form id="searchForm" modelAttribute="dcJobTransIntf"  method="post" class="form-inline">
				<table:sortColumn id="orderBy" name="orderBy" value="${page.orderBy}" callback="sortOrRefresh();"/><!-- 支持排序 -->
				<form:hidden path="jobType" value="2"/>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="pull-left">
				<table:openModalDialog url="${ctx}/dc/dataProcess/transIntf/dataForm?jobType=2" title="soap webservice采集任务配置" width="1000px" height="700px"></table:openModalDialog><!-- 增加按钮 -->
			</div>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable display" cellspacing="0" width="100%">
		...
		<tr>
			...
			<th class="wsPath">采集接口URL</th>
			<th class="wsMethod">调用方法</th>
