...
<html>
<head>
  <title>调度任务Quartz - 在线Cron表达式生成器</title>
    <link href="${ctxStatic}/dc/quartz/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="${ctxStatic}/dc/quartz/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${ctxStatic}/dc/quartz/Cron/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
...
<body>
    <center>
        ...
        <div class="easyui-layout" style="width:785px;height:470px; border: 1px rgb(202, 196, 196) solid; border-radius: 5px;">
            ...
            <br/>
            <div data-options="region:'south',border:false" style="height:200px;margin:10px 10px;">
                    ...
                    <table style="height: 100px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="v_second" class="col" value="*" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_min" class="col" value="*" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_hour" class="col" value="*" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_day" class="col" value="*" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_mouth" class="col" value="*" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_week" class="col" value="?" readonly="readonly" style="width:90px" />
                                </td>
                                <td>
                                    <input type="text" name="v_year" class="col" readonly="readonly" style="width:90px" />
                                </td>
                            </tr>
                            <tr>
							    <td>表达式:</td>
							    <td colspan="5">
                                <input type="text" name="cron" style="width: 100%;" value="${cronExpr}" id="cron" /></td>
								<td></td>
							    <!-- <td><input type="button" value="反解析到UI " id="btnFan" onclick="btnFan()"/></td> -->
							    <td><a id="btnFan" href="#" class="easyui-linkbutton" iconcls="icon-reload" plain="true" onclick="btnFan()">反解析到UI</a></td>
						    </tr>
                ...
                <div style="text-align: right; margin-top: 20px;">
					<a href="#" class="easyui-linkbutton" iconcls="icon-save" onclick="saveCronScript()">确认</a> 
					<a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="closeThisWin()">取消</a> 
                    <div>
                    </div>
                </div>
            </div>
	...
	<script type="text/javascript">
	   ...
	   /*  $.parser.parse($("body"));
		...
		function doSubmit(index, method) {
			if($('#cron').val()){
				method.updateCronExpr($('#cron').val());
				top.layer.close(index);
			}else{
				top.layer.alert('请配置调度表达式!', { title : '系统提示' });
				return false;
			}
		}
    ...
    <script src="${ctxStatic}/dc/quartz/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
    <script src="${ctxStatic}/dc/quartz/Cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${ctxStatic}/dc/quartz/Cron/cron.js" type="text/javascript"></script>
</body>
</html>
