<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.hleast.com/"/>
...
<!-- 引入项目的js脚本 peijd -->
<script src="${ctxStatic}/dc/js/dcCommon.js" type="text/javascript"></script>
