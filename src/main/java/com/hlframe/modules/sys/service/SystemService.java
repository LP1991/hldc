...
import com.hlframe.common.security.Digests;
...
import com.hlframe.common.utils.Encodes;
import com.hlframe.common.utils.StringUtils;
import com.hlframe.modules.sys.dao.MenuDao;
import com.hlframe.modules.sys.dao.RoleDao;
...
import com.hlframe.modules.sys.security.SystemAuthorizingRealm;
import com.hlframe.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> findSameLevelMenus(String parentId){
		List<Menu> menuList = menuDao.getSameLevelMenus(parentId);
		return menuList;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n"+Global.getConfig("system.productName")+" - Powered By http://www.hleast.com\r\n");
		sb.append("\r\n======================================================================\r\n");
		return true;
	}
	...
	public Page<Menu> findMenu(Page<Menu> page, Menu menu) {
		menu.setPage(page);
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	/*getByRoled当角色存在用户不允许删除方法
	 * 2017,4月26日 下午2:30
	 * bao gang
	 */
	public Role getByRoled(String id) {
		Role r = new Role();
		r.setId(id);
		return roleDao.getByRoled(r);
	}
