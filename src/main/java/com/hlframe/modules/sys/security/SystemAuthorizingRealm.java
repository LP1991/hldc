 ...
 */
package com.hlframe.modules.sys.security;
...
import com.hlframe.common.web.Servlets;
...
import com.hlframe.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	//这里注解掉 HttpServletRequest 只为实现单元测试
//	@Autowired
//	HttpServletRequest request;
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		//获取HttpServletRequest   如果通过@Autowired HttpServletRequest 获取, 则单元测试无法加载  peijd at 2016-11-4
...
//		boolean mobile = false;
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		// 获取当前已登录的用户
		if (!Global.TRUE.equals(Global.getConfig("system.multiAccountLogin"))){
