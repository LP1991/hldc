 ...
 */
package com.hlframe.modules.gen.entity;
...
public class GenTable extends DataEntity<GenTable> {
	...
	private String tableType; //表类型 单表 主表 附表
	private String className;		// 实体类名称
	private String parentTable;		// 关联主表
    ...
    public List<String> getImportGridJavaList()
    {
        ...
        for (GenTableColumn column : getColumnList()) {
            ...
            if(column.getTableName() != null 
            		&& !column.getTableName().equals("") 
            		&& StringUtils.indexOf(column.getJavaType(), ".") != -1 
