...
import com.hlframe.modules.dc.schedule.dao.DcTaskTimeDao;
...
/** 
 * @类名: com.hlframe.modules.dc.schedule.service.DcTaskTimeService.java 
 * @创建者: cdd
 * @职责说明: 调度任务管理 Service
...
public class DcTaskTimeService extends CrudService<DcTaskTimeDao, DcTaskTime> {
	...
	public TaskInfo buildTaskInfo(TaskInfo task, DcTaskMain dcTaskMain) throws Exception {
		...
		task.setProgramTpye(dcTaskMain.getProgramTpye()); 	// 参数类型
		task.setPrograms(dcTaskMain.getParameter()); 		// 参数
