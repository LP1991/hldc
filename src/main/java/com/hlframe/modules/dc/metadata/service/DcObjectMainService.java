...
import com.hlframe.common.utils.*;
...
public class DcObjectMainService extends CrudService<DcObjectMainDao, DcObjectMain> {
	...
	@Autowired // 标签表dao
	private DcSearchLabelDao dcSearchLabelDao;
	@Autowired // 数据表dao
	 ...
	 */
	@Transactional(readOnly = false)
	public void getAu(DcObjectMain obj) {
...
//更新到ES
	 ...
	 * @param dcSearchLabel
	 * @return
	 * @create by hgw at 2017年3月8日 下午1:36:34
	 */
	public Page<DcSearchLabel> findLabelList(Page<DcSearchLabel> page, DcSearchLabel dcSearchLabel) {
		dcSearchLabel.setPage(page);
		page.setList(dcSearchLabelDao.findLabelListByObjId(dcSearchLabel.getId()));
		return page;
	}
	...
	@Transactional(readOnly = false)
	public AjaxJson Labeldelete(DcSearchLabelRef obj) {
		AjaxJson ajaxJson = new AjaxJson();
		try {
			dcSearchLabelDao.deleteLabelRef(obj);;
