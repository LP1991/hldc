...
public class DcHiveTableService extends CrudService<DcHiveTableDao, DcHiveTable>{
	...
	private DcObjectMainService dcObjMainService;
 ...
 */
	...
	public List<Map<String,Object>> selectData(DcHiveTable obj) {   
		String sql = "select * from " +obj.getTableSpace() +"."+obj.getTableName();//构建sql语句
	    return  executeQuerySql(sql, Integer.parseInt(DcPropertyUtils.getProperty("extractdb.preview.datanum","20")));
	   } 
	...
	public List<Map<String, Object>> loadData(String location, String separatorSign) {
		...
		dcHdfsFileService.loadFileContent(file, "10");//获取location的文件内容
